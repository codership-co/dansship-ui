...
export enum DANSSHIP_ERROR_CODE {
  ...
  AUTH_OTP_INVALID = 'AUTH_OTP_INVALID', // VALIDATION_ERROR = Password-reset OTP is invalid, expired, or already used |
  GOOGLE_AUTH_NOT_ALLOWED_FOR_ADMIN = 'GOOGLE_AUTH_NOT_ALLOWED_FOR_ADMIN',
  ...
  BOOKING_SUBSCRIPTION_EXPIRED = 'BOOKING_SUBSCRIPTION_EXPIRED', // VALIDATION_ERROR = Class is after the plan expiration date |
  ...
  BOOKING_INSTRUCTOR_OWN_CLASS = 'BOOKING_INSTRUCTOR_OWN_CLASS', // VALIDATION_ERROR = Instructor cannot book the class they are assigned to teach |
  BOOKING_INSTRUCTOR_TEACHING_OVERLAP = 'BOOKING_INSTRUCTOR_TEACHING_OVERLAP', // VALIDATION_ERROR = Instructor cannot book a class that overlaps a teaching assignment |
  BOOKING_CLASS_CANCELLED = 'BOOKING_CLASS_CANCELLED', // VALIDATION_ERROR = Class is cancelled and cannot be reopened for retroactive attendance |
  BOOKING_NOT_CANCELLABLE = 'BOOKING_NOT_CANCELLABLE', // BUSINESS_RULE_VIOLATION = Booking is not active and cannot be cancelled |
  JUEVES_2X1_NOT_ELIGIBLE = 'JUEVES_2X1_NOT_ELIGIBLE',
  JUEVES_2X1_COMPANION_NOT_FOUND = 'JUEVES_2X1_COMPANION_NOT_FOUND',
  JUEVES_2X1_SELF_REFERENCE = 'JUEVES_2X1_SELF_REFERENCE',
  ...
  DUO_SELF_REFERENCE = 'DUO_SELF_REFERENCE',
  DUO_NOT_AVAILABLE = 'DUO_NOT_AVAILABLE',
  DUO_PLAN_NOT_ELIGIBLE = 'DUO_PLAN_NOT_ELIGIBLE',
  DUO_DISCOUNT_NOT_ALLOWED = 'DUO_DISCOUNT_NOT_ALLOWED',
  DUO_GIFT_COMBINATION = 'DUO_GIFT_COMBINATION',
  DUO_INVALID_PARTNER_EMAIL = 'DUO_INVALID_PARTNER_EMAIL',
  QUARTERLY_DUO_COMBINATION = 'QUARTERLY_DUO_COMBINATION',
  ...
  // Workshops
  INSTRUCTOR_PROFILE_NOT_FOUND = 'INSTRUCTOR_PROFILE_NOT_FOUND', // RESOURCE_NOT_FOUND = Authenticated user has no instructor profile |
  WORKSHOP_INSTRUCTOR_FORBIDDEN = 'WORKSHOP_INSTRUCTOR_FORBIDDEN', // AUTHORIZATION_ERROR = User is not the assigned workshop instructor |
  WORKSHOP_SOLD_OUT = 'WORKSHOP_SOLD_OUT', // CONFLICT = Workshop or combo has no remaining seats |
  WORKSHOP_ALREADY_REGISTERED = 'WORKSHOP_ALREADY_REGISTERED', // CONFLICT = Student or partner already holds a seat |
  WORKSHOP_COMBO_COMPONENTS_UNPUBLISHED = 'WORKSHOP_COMBO_COMPONENTS_UNPUBLISHED', // VALIDATION_ERROR = Combo requires published component workshops |
}
/* eslint-enable */
...
const SKIP_API_ERROR_CODES = new Set<DANSSHIP_ERROR_CODE>([
  ...
  DANSSHIP_ERROR_CODE.AUTH_OTP_INVALID,
  ...
  DANSSHIP_ERROR_CODE.BOOKING_SUBSCRIPTION_EXPIRED,
  DANSSHIP_ERROR_CODE.BOOKING_LATE_JOIN_CLOSED,
  DANSSHIP_ERROR_CODE.BOOKING_INSTRUCTOR_OWN_CLASS,
  DANSSHIP_ERROR_CODE.BOOKING_INSTRUCTOR_TEACHING_OVERLAP,
  DANSSHIP_ERROR_CODE.BOOKING_CLASS_CANCELLED,
  DANSSHIP_ERROR_CODE.BOOKING_NOT_CANCELLABLE,
  DANSSHIP_ERROR_CODE.JUEVES_2X1_NOT_ELIGIBLE,
  DANSSHIP_ERROR_CODE.JUEVES_2X1_COMPANION_NOT_FOUND,
  DANSSHIP_ERROR_CODE.JUEVES_2X1_SELF_REFERENCE,
  ...
  DANSSHIP_ERROR_CODE.INVALID_SCHEDULE_STATE,
  ...
  DANSSHIP_ERROR_CODE.DUO_SELF_REFERENCE,
  DANSSHIP_ERROR_CODE.DUO_NOT_AVAILABLE,
  DANSSHIP_ERROR_CODE.DUO_PLAN_NOT_ELIGIBLE,
  DANSSHIP_ERROR_CODE.DUO_DISCOUNT_NOT_ALLOWED,
  DANSSHIP_ERROR_CODE.DUO_GIFT_COMBINATION,
  DANSSHIP_ERROR_CODE.DUO_INVALID_PARTNER_EMAIL,
  DANSSHIP_ERROR_CODE.QUARTERLY_DUO_COMBINATION,
  DANSSHIP_ERROR_CODE.INSTRUCTOR_PROFILE_NOT_FOUND,
  DANSSHIP_ERROR_CODE.WORKSHOP_INSTRUCTOR_FORBIDDEN,
  DANSSHIP_ERROR_CODE.WORKSHOP_SOLD_OUT,
  DANSSHIP_ERROR_CODE.WORKSHOP_ALREADY_REGISTERED,
  DANSSHIP_ERROR_CODE.WORKSHOP_COMBO_COMPONENTS_UNPUBLISHED,
]);
