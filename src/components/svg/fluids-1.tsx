...
export const Fluids1 = ({ className, style }: FluidsProps) => (
  <svg className={className} style={style} viewBox='0 0 493 440' fill='none' xmlns='http://www.w3.org/2000/svg'>
    <g clipPath='url(#clip0_69_15903)'>
      <mask
        id='mask0_69_15903'
        ...
        height='675'
      >
        <path className='animate-gradients-floatB delay-[100ms]' d='M0 0L0 674.646H493.228L493.228 0H0Z' fill='white' />
      </mask>
      <g mask='url(#mask0_69_15903)'>
        <path
          className='animate-gradients-floatB delay-[200ms]'
      ...
      <mask
        ...
        height='675'
      >
        <path className='animate-gradients-floatB delay-[300ms]' d='M0 0L0 674.646H493.228L493.228 0H0Z' fill='white' />
      </mask>
      <g mask='url(#mask1_69_15903)'>
        <path
          className='animate-gradients-floatB delay-[400ms]'
          opacity='0.2'
      ...
      <mask
        ...
        height='675'
      >
        <path className='animate-gradients-floatB delay-[500ms]' d='M0 0L0 674.646H493.228L493.228 0H0Z' fill='white' />
      </mask>
      <g mask='url(#mask2_69_15903)'>
        <path
          className='animate-gradients-floatB delay-[600ms]'
          ...
          fill='url(#paint1_linear_69_15903)'
        />
      </g>
      <mask
        id='mask3_69_15903'
        ...
        height='675'
      >
        <path className='animate-gradients-floatB delay-[700ms]' d='M0 0L0 674.646H493.228L493.228 0H0Z' fill='white' />
      </mask>
      <g mask='url(#mask3_69_15903)'>
        <path
          className='animate-gradients-floatB delay-[800ms]'
          opacity='0.1'
      ...
      <mask
        ...
        height='675'
      >
        <path className='animate-gradients-floatB delay-[900ms]' d='M0 0L0 674.646H493.228L493.228 0H0Z' fill='white' />
      </mask>
      <g mask='url(#mask4_69_15903)'>
        <path
          className='animate-gradients-floatB delay-[1000ms]'
          opacity='0.1'
    ...
    <defs>
      ...
      >
        ...
        <stop offset='0.1159' stopColor='var(--color-tertiary-600)' />
        <stop offset='0.3096' stopColor='var(--color-tertiary-500)' />
        <stop offset='0.5574' stopColor='var(--color-tertiary-400)' />
        <stop offset='0.8464' stopColor='var(--color-tertiary-300)' />
        <stop offset='1' stopColor='var(--color-tertiary-200)' />
      </linearGradient>
      <linearGradient
        id='paint1_linear_69_15903'
        x1='-115.874'
        y1='-242.763'
        x2='258.126'
        y2='321.237'
      ...
      >
        ...
        <stop offset='0.0993' stopColor='var(--color-primary-600)' />
        <stop offset='0.2695' stopColor='var(--color-primary-500)' />
        <stop offset='0.49' stopColor='var(--color-primary-400)' />
        <stop offset='0.7492' stopColor='var(--color-primary-300)' />
        <stop offset='1' stopColor='var(--color-primary-200)' />
      </linearGradient>
      <clipPath id='clip0_69_15903'>
