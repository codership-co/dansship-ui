...
export const AuthFormLayout = ({ isFlipped, gradientsImage, title, subtitle, children }: AuthFormLayoutProps) => {
  return (
    <div className='min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8'>
      <section className='shadow-2xl rounded-xl md:rounded-lg max-w-100 md:max-w-6xl w-full'>
        <div
          className={cn(
            'bg-white grid rounded-xl md:rounded-lg w-full md:h-200 overflow-hidden',
            isFlipped
        ...
        >
          ...
          <section
            className='relative pt-12 px-10 pb-8 grid content-center h-full overflow-auto'
            style={{
              gridArea: 'form',
