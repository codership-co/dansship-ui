...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        'flex w-full items-center justify-between gap-2 rounded-2xl bg-gray-200/50 px-6 py-4 mb-0',
        ...
        '*:data-[slot=select-value]:gap-2 dark:bg-accent/30 dark:hover:bg-accent/50',
