      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 p-2 rounded-full opacity-70 transition-opacity cursor-pointer hover:opacity-100 bg-primary-50/20 hover:bg-primary-200/50 focus:ring-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <LuX />
